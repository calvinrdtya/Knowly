<div class="app-brand demo">
    <a href="" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">
        <img src="{{ asset('home/assets/images/logo.png') }}" alt="" style="width: 7% !important">
      </span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Layouts -->
    <li class="menu-item {{ request()->routeIs('kalender.index') ? 'active open' : '' }}">
    ...
    <li class="menu-item {{ request()->routeIs('assignments.index', 'assignments.show', 'teacher.assignments.show') ? 'active' : '' }}">
    ...
    <li class="menu-item {{ request()->routeIs('teacher.jadwal.index', 'teacher.schedules.show') ? 'active' : '' }}">
      <a href="{{ route('teacher.jadwal.index') }}" class="menu-link">
        <i class="menu-icon bx bx-calendar-event"></i>
        <div data-i18n="Account Settings">Jadwal</div>
      </a>
    </li>
    <li class="menu-item {{ request()->routeIs('teacher.quizzes.index', 'teachers.quizzes.show', 'teacher.quizzes.create') ? 'active open' : '' }}">
      ...
      <ul class="menu-sub">
        <li class="menu-item {{ request()->routeIs('teacher.quizzes.index', 'teachers.quizzes.show', 'teacher.quizzes.create') ? 'active' : '' }}">
