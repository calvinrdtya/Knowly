            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <div class="d-flex align-items-end row">
                                    <div class="col-sm-7">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('teacher.jadwal.index') }}" class="btn btn-sm btn-outline-primary">Lihat Jadwal</a>
                                        </div>
                                    </div>
                    ...
                    <div class="card p-4">
                        <div class="row my-0">
                            <div class="col-md-6">
                                <h5 class="card-title text-dark">Tugas yang Anda buat</h5>
                                @foreach($assignments as $assignment)
                                    <div class="card card-hov border-1 my-4">
