                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="card w-50 p-5">
                            <div class="card-title">
                                <h4 class="card-title text-dark mb-0">Buat Kuis</h4>
                            </div>
                            <form action="{{ route('quiz.store') }}" method="POST">
                                ...
                                <div class="card-body p-1">
                                    ...
                                    <div class="my-3">
                                        ...
                                        <select class="form-control" name="class_id" id="class_id"class="form-select" value="1" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="subject_id" id="subject_id" class="form-select" value="21" required>
                                            <option value="21">Basis Data</option>
                                        </select>
                                    </div>
