                    ...
                    <div class="card mb-4">
                        <div class="card-body p-0">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route('teacher.quizzes.create') }}" class="btn btn-sm btn-primary">Buat Kuis</a>
                            </div>
                        </div>                        
                    </div>
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-12 mb-4">
                                <div class="card" style="height: 100%; position: relative;">
                                    <div class="card-body" style="position: relative; height: 100%;">
                                        ...
                                        <span class="d-block mb-5">{{ $quiz->description }}</span>
                                        <a href="{{ route('teachers.quizzes.show', $quiz) }}" class="btn btn-sm btn-info" style="position: absolute; bottom: 16px; right: 16px;">
                                            Lihat Kuis
                                         </a>                                                                                                                                              
                                    </div>
                                </div>
