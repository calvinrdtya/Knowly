                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            {{-- <div class="mt-4">
                                ...
                                <h3 class="card-title mb-2">{{ $users->where('user_type', 'student')->count() }}</h3>
                            </div> --}}
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <h3 class="card-title mb-2">{{ $users->where('user_type', 'teacher')->count() }}</h3>
                          </div> --}}
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                              ...
                              {{-- <h3 class="card-title mb-2">{{ $users->where('user_type', 'admin')->count() }}</h3> --}}
                            </div>
                          </div>
                      </div>
                      <div class="col-6 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            {{-- <h3 class="card-title mb-2">{{ $users->where('user_type', 'parent')->count() }}</h3> --}}
                          </div>
                        </div>
                      </div>
                      <!-- </div>
