                    ...
                    <div class="card p-4">
                        <div class="row my-0">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    @if($isAlreadyAttended)
                                                        <button class="btn btn-sm w-100 btn-primary d-flex align-items-center justify-content-center" disabled>
                                                            Presensi
                                                        </button>
                                                    @else
                                                        <a href="{{ route('attendance.mark.view', ['subject_id' => $subject->id]) }}" class="btn btn-sm w-100 btn-primary d-flex align-items-center justify-content-center">
                                                            Presensi
                                                        </a>
                                                    @endif
                                                    {{-- @if (!$attendance)
                                                    ...
                                                    @else
                                                        <button class="btn btn-sm w-100 btn-primary d-flex align-items-center justify-content-center" 
                                                            @if($isAlreadyAttended) disabled @endif>
                                                            Presensi
                                                        </button>
                                                    @endif --}}
                                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card shadow-none mb-3" style="height: auto; position: relative;">
                                    <div class="card-body p-3">
