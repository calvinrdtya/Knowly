                            ...
                            <div class="col-lg-9 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">Kuliah Semester Ganjil Tahun Ajaran 2024/2025</h5>
                                                <p class="mb-3">
                                                    Knowledge Network for Online Web-based Learning and Yield
                                                </p> 
                                                <a href="javascript:;" class="btn btn-sm btn-outline-primary">Lihat Jadwal</a>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    <div class="card-body p-4">
                                        ...
                                        <span class="d-block mb-0">Ada Tugas Baru</span>
                                        <h2 class="card-title mb-0">{{ $jumlahTugas }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
