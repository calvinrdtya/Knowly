<div class="app-brand demo">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->routeIs('student.jadwal.index') ? 'active' : '' }}">
      <a href="{{ route('student.jadwal.index') }}" class="menu-link">
        <i class="menu-icon bx bx-calendar"></i>
    ...
    <li class="menu-item {{ request()->routeIs('student.quizzes.index', 'student.quizzes.show') ? 'active open' : '' }}">
      <a href="{{ route('student.quizzes.index') }}" class="menu-link menu-toggle">
        <i class="menu-icon bx bx-edit-alt"></i>
        <div data-i18n="Layouts">Ujian Online</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item {{ request()->routeIs('student.quizzes.index', 'student.quizzes.show') ? 'active' : '' }}">
