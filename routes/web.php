...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::get('siswa/mapel', [StudentRecordController::class, 'schedule'])->name('student.schedule');
...
Route::get('quiz/{quiz}', [QuizController::class, 'showKuisTeacher'])->name('teachers.quizzes.show');
Route::get('quizzes/create', [QuizController::class, 'createKuis'])->name('teacher.quizzes.create');
Route::post('quiz/store', [QuizController::class, 'store'])->name('quiz.store');
Route::get('quiz/submissions/{quiz}', [QuizController::class, 'submission'])->name('quiz.submissions');

// Route::get('teachers/quizzes', [QuizController::class, 'getQuizTeacher'])->name('teachers.quizzes');
// Route::get('quizzes/{quiz}', [QuizController::class, 'lihatKuis'])->name('teachers.quizzes.show');
...
Route::get('assignments/{subject_id}/list', [AssignmentController::class, 'assignmentShow'])->name('teacher.assignments.show');
...
//jadwal Pelajaran
Route::get('guru/schedule', [JadwalController::class, 'teacherSchedules'])->name('teacher.jadwal.index');
Route::get('siswa/schedule', [JadwalController::class, 'studentSchedules'])->name('student.jadwal.index');